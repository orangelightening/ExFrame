                    ...
                    if "tool_calls" in message and message["tool_calls"]:
                        ...
                        if function_name == "web_search":
                            ...
                            if brave_search_used:
                                ...
                                # Add sources section for clarity
                                formatted_content = search_content
                                if not formatted_content.endswith('\n'):
                                    formatted_content += '\n'
                                formatted_content += '\n---\n\n'
                                formatted_content += '**Sources:** This answer was generated by Brave Search AI, '
                                formatted_content += 'which synthesizes information from current web sources. '
                                formatted_content += 'Source attributions are mentioned inline in the text above.\n\n'
                                formatted_content += '🔍 *Powered by [Brave Search](https://search.brave.com/) - '
                                formatted_content += f'Fast web research with AI synthesis (Query time: {time_ms/1000:.1f}s)*'
